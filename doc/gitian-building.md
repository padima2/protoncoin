...
git clone https://github.com/protoncoin/proton
```
...
```bash
    ...
    From https://github.com/protoncoin/proton
...
BTCPATH=/some/root/path/proton.git
SIGPATH=/some/root/path/proton-detached-sigs.git
